...
# Add evaluation/ to path so shared module is resolvable
EVAL_DIR = Path(__file__).parent.parent.parent / "evaluation"
sys.path.insert(0, str(EVAL_DIR))
sys.path.insert(0, str(EVAL_DIR / "02-precision"))
...
PROMPTS_DIR = EVAL_DIR / "02-precision" / "prompts"

# Setup
oai_client = get_openai_client()
prompt = load_yaml_prompt("conservative.yaml", prompts_dir=PROMPTS_DIR)
